...
async function processDataAndProgress() {
    ...
    try {
        ...
        const { data: partResult, error: partError } = await supabase
            ...
            .insert([{
                nome: partData.nome,
                idade: partData.idade,
                cidade_uf: partData.cidade_uf,
        ...
        // We proceed anyway to avoid blocking the user experience on demo, 
        // but in prod we might show an error state.
    }
